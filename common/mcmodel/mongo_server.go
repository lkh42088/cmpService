...
func (v MgoVm) Compare(n MgoVm) bool {
	if v.Name != n.Name { return true }
	if v.Cpu != n.Cpu { return true }
	if v.Ram != n.Ram { return true }
	if v.Hdd != n.Hdd { return true }
	if v.Desc != n.Desc { return true }
	if v.OS != n.OS { return true }
	if v.Image != n.Image { return true }
	if v.Filename != n.Filename { return true }
	if v.VmIndex != n.VmIndex { return true }
	if v.FullPath != n.FullPath { return true }
	if v.IpAddr != n.IpAddr { return true }
	if v.Mac != n.Mac { return true }
	if v.CurrentStatus != n.CurrentStatus { return true }
	if v.RemoteAddr != n.RemoteAddr { return true }
	return false
}

func (v MgoNetwork) Compare(n MgoNetwork) bool {
	if v.Name != n.Name { return true }
	if v.Bridge != n.Bridge { return true }
	if v.Mode != n.Mode { return true }
	if v.Mac != n.Mac { return true }
	if v.DhcpStart != n.DhcpStart { return true }
	if v.DhcpEnd != n.DhcpEnd { return true }
	if v.Ip != n.Ip { return true }
	if v.Netmask != n.Netmask { return true }
	if v.Prefix != n.Prefix { return true }
	return false
}

func (v MgoImage) Compare(n MgoImage) bool {
	if v.Name != n.Name { return true }
	if v.Variant != n.Variant { return true }
	if v.Hdd != n.Hdd { return true }
	if v.Desc != n.Desc { return true }
	if v.FullName != n.FullName { return true }
	return false
}
