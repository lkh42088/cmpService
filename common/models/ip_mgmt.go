...
type IpMgmt struct {
	...
	NetworkId		int			`gorm:"type:int(11);not null;column:ip_net_id_cd;comment:'네트워크 코드'"`
	DevIp			string		`gorm:"type:varchar(15);not null;column:ip;comment:'IP'"`
	NatIp			string		`gorm:"type:varchar(15);not null;column:ip_nat;comment:'NAT IP'"`
	...
	DevUse			bool		`gorm:"type:tinyint;not null;default:1;column:ip_use_flag;comment:'사용 여부'"`
}
