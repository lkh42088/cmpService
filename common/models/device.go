...
type DeviceCommonResponse struct {
	...
	CommentCnt       int       `gorm:"type:int911);column:comment_cnt;comment"`
	...
	MonitoringFlag   int       `gorm:"type:int(11);column:monitoring_flag"`
...
type DeviceLog struct {
	...
	RegisterDate time.Time `gorm:"column:register_date;default:CURRENT_TIMESTAMP;comment:'로그 발생일'"`
}
